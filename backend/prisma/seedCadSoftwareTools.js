...
async function getBatchOwner() {
  ...
  throw new Error(
    "No active TUTOR or ADMIN found. Create one tutor/admin first.",
  );
}
...
async function main() {
  ...
  const course = await prisma.course.upsert({
    ...
    update: {
      ...
      description:
        "Software training package for CATIA V5, UG NX and SolidWorks. Pricing: 1 course ₹10000, 2 courses ₹14000, 3 courses ₹15000.",
      duration_months: 1,
      price: 10000,
      overview_points: [
        "CATIA V5 software training",
        "UG NX software training",
        "SolidWorks software training",
        "Live day and practice day learning",
        "Online / Offline Pune-Nigdi / Hybrid options",
      ],
    ...
    if (!existing) {
      await prisma.batch.create({
        data: {
          ...
          max_students: 50,
          description:
            "CAD software tools training batch. Live session one day, next day practice task.",
          zoom_link: "",
