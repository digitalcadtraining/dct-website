...
import TutorLoginPage from "../pages/auth/TutorLoginPage.jsx";
...
} from "../pages/student/SessionsPages.jsx";
import {
  AllAssignmentsPage,
  AssignmentFeedbackPage,
} from "../pages/student/AssignmentsPages.jsx";
import MyCourses from "../pages/student/MyCourses.jsx";
import MyReferrals from "../pages/student/MyReferrals.jsx";
...
export default function AppRoutes() {
  return (
    <Routes>
      ...
      <Route
        path="/courses/plastic-product-design"
        element={<PlasticProductDesignPage />}
      />
      <Route
        path="/courses/biw-product-design"
        element={<BIWProductDesignPage />}
      />
      <Route
        path="/courses/analysis-with-ansys"
        element={<AnalysisWithAnsysPage />}
      />
      <Route path="/courses/mould-design" element={<MouldDesignPage />} />
      <Route
        path="/courses/catia-basic"
        element={<CADSoftwareToolsPage slug="catia-basic" />}
      />
      <Route
        path="/courses/nx-basic"
        element={<CADSoftwareToolsPage slug="nx-basic" />}
      />
      <Route
        path="/courses/solidworks-basic"
        element={<CADSoftwareToolsPage slug="solidworks-basic" />}
      />
      ...
      <Route
        ...
        element={<RegisterPaymentSuccessPage />}
      />
      ...
      <Route
        ...
        element={
          <ProtectedRoute roles={["student"]}>
            <Navigate to="/student/prerequisites/tool-installation" replace />
          </ProtectedRoute>
        }
      />
      <Route
        path="/student/prerequisites/tool-installation"
        element={
          <ProtectedRoute roles={["student"]}>
            <PrerequisitesPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/student/prerequisites/catia-basics"
        element={
          <ProtectedRoute roles={["student"]}>
            <PrerequisitesPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/student/sessions/completed"
        element={
          <ProtectedRoute roles={["student"]}>
            <CompletedSessionsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/tutor/batches/:batchId/sessions"
        element={
          <ProtectedRoute roles={["tutor"]}>
            <TutorSessionsPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/admin/prerequisite-progress"
        element={
          <ProtectedRoute roles={["admin"]}>
            <AdminPrerequisiteProgress />
          </ProtectedRoute>
        }
      />
      <Route
