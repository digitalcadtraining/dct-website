  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (tab === "student" && role !== "student") {
        return setErr("This is a tutor account. Please select Tutor tab and login again.");
      }
      if (tab === "tutor" && role !== "tutor") {
        return setErr("This is a student account. Please select Student tab and login again.");
      }
