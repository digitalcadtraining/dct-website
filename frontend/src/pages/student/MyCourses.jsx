          ...
          {[
            ...
            [
              ...
              enrollment.emi_first_due
                ? `₹${Number(enrollment.enrolled_price || 0).toLocaleString("en-IN")} · ${fmt(enrollment.emi_first_due)}`
                : "—",
            ],
            [
              "Second EMI",
              enrollment.emi_second_due
                ? `Due ${fmt(enrollment.emi_second_due)}`
                : "—",
            ],
          ].map(([l, v]) => (
            <div
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-dct-gray">
                CATIA basics, UG NX basics are now available in a structured
                video player. Complete lessons in sequence to build confidence
                before live domain training starts.
              </p>
            </div>
            <Link
