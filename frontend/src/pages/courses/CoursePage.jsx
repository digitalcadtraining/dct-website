...
.dct-course-project-image-box img{
  max-width:90%;
  max-height:90%;
  object-fit:contain;
  display:block;
}dct-course-company-grid{grid-template-columns:1fr}.dct-course-range-tabs{grid-template-columns:repeat(2,1fr)}.dct-course-session-row{grid-template-columns:48px 1fr}.dct-course-session-chip{grid-column:2;justify-self:start}.dct-course-trust-mini-stats{grid-template-columns:1fr}.dct-course-package-band{grid-template-columns:1fr}.dct-course-company-toolbar{flex-direction:column;align-items:stretch}.dct-course-bottom-cta{display:grid}}
`;
...
function getEmiPlan(batchStartDate, currentPrice) {
  ...
  return { registrationFee, firstEmi, secondEmi, firstDate, secondDate };
}
                    ...
                    <div className="dct-course-project-dual">
                      {project.frontImage && (
                        <div>
                          ...
                          <div className="dct-course-project-image-box">
                            <img
